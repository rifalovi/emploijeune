...
/** Rôles métier autorisés à la création par admin_scs (pas admin_scs lui-même). */
export const ROLES_CREABLES = [
  'editeur_projet', // chef de projet OIF (coordonnateur)
  'contributeur_partenaire', // structure / partenaire terrain
  'lecteur', // accès lecture seule (rare)
] as const;
