    ...
    <div className="space-y-5">
      <header className="space-y-1">
        ...
        <p className="text-muted-foreground text-sm">
          Analysez les données d’enquête avec le moteur <strong>SCS DataStudio</strong> : tris à
          plat, croisements et tableaux de fréquences, sans quitter la plateforme.
        </p>
      </header>
