              ...
              >
                <span className="flex-1">
                  ...
                  <span className="mt-1 block text-xs text-purple-700">
                    ...
                    automatiquement. ~200 tokens estimés. Le rapport indique le score de confiance
                    par ligne.
                  </span>
                </span>
                <Switch
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="sr-only">
              Proposition de réessayer l'import avec l'IA
            </DialogDescription>
            <div className="space-y-3 pt-1 text-sm">
              <div>
                <p>L'import Excel standard a rencontré des difficultés sur ce fichier :</p>
                ...
                <p>
                  ...
                  contenu sans se soucier du format exact des colonnes, et reconnaît les valeurs en
                  texte libre.
                </p>
                <p className="text-muted-foreground text-xs">
                  Disponible pour les comptes administrateurs. Les lignes extraites passeront dans
                  le même pipeline de validation.
                </p>
              </div>
            </div>
          </DialogHeader>
          <DialogFooter className="gap-2 sm:flex-row">
            ...
            <Button
              ...
              disabled={pending}
              className="gap-2 bg-[#5D0073] text-white hover:bg-[#5D0073]/90"
            >
              {pending ? (
                <>
