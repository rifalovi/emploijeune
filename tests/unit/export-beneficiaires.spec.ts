...
const fixtureRows: BeneficiaireListItem[] = [
  {
    ...
    tranche_age_declaree: 'Jeune',
    projet_code: 'PROJ_A16a',
    pays_code: 'MLI',
    partenaire_accompagnement: null,
    domaine_formation_code: 'NUM_INFO',
    intitule_formation: null,
    modalite_formation_code: 'PRESENTIEL',
  ...
  },
  {
    ...
    sexe: 'M',
    date_naissance: null,
    tranche_age_declaree: null,
    projet_code: 'PROJ_A16a',
    pays_code: 'BFA',
    partenaire_accompagnement: null,
    domaine_formation_code: 'ENTREPR_GEST',
    intitule_formation: null,
    modalite_formation_code: null,
